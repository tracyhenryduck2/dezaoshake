...
public class SFunctionGroupDAO extends BaseDAO { 
    ...
    public List<Map<String,Object>> getFunctionGroupList(){
    	String sql = "select * from s_function_group order by sort";
    	List<Map<String,Object>> list= j.queryForList(sql);
    	for(Map<String,Object> map:list){
    		Long id = Long.parseLong(map.get("id")+"");
    		String sql2 = "select a.name,a.url from s_function a left join s_function_group b on a.function_group_id=b.id where b.id="+id;
